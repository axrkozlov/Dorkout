...
//            View view = LayoutInflater.from(getContext()).inflate(R.layout.z_workout_exercise_item, parent, false);
...
//            numberView = itemView.findViewById(R.id.order);
//            collapseButton = itemView.findViewById(R.id.change_order);
